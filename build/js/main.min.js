...
var _swipers = require("./modules/swipers/swipers");
// ---------------------------------
...
},{"./modules/form-validate/form":3,"./modules/swipers/swipers":9,"./modules/tabs/init-tabs":10,"./modules/video/video":12,"./utils/ios-vh-fix":14}],2:[function(require,module,exports){
"use strict";
...
var coachesSwiper = document.querySelector('[data-swiper="coaches"');
var reviewsSwiper = document.querySelector('[data-swiper="reviews"');
var initSwipers = function initSwipers() {
  if (reviewsSwiper) {
    (function () {
      return new _swiper.default('[data-swiper="reviews"', {
  ...
  if (coachesSwiper) {
    (function () {
      return new _swiper.default('[data-swiper="coaches"]', {
        direction: 'horizontal',
        loop: true,
        navigation: {
...
function initVideo() {
  var parent = document.querySelector('[data-video="parent"]');
  var video = parent.querySelector('[data-video="element"]');
  var btnPlay = parent.querySelector('[data-video="button-play"');
  var poster = parent.querySelector('[data-video="poster"]');
